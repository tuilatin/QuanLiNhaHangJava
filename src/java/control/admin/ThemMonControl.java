 ...
 * @author FPT
 */
@WebServlet(name = "ThemMonControl", urlPatterns = {"/addproduct"})
public class ThemMonControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao= new DAO();
        dao.insertMonAn(TenMon, DonGia, ID_Loai, MoTa, Image, TrangThai);
