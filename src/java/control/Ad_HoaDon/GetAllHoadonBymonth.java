 ...
 * @author FPT
 */
@WebServlet(name = "GetAllHoadonBymonth", urlPatterns = {"/hoadonmonth"})
public class GetAllHoadonBymonth extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("title", "Tất cả hóa đơn Tháng này");
        
        LocalDate today = LocalDate.now();
        int currentMonth = today.getMonthValue(); // Tháng hiện tại (1–12)
        int currentYear = today.getYear();        // Năm hiện tại

        request.setAttribute("time", "Tháng "+currentMonth+" Năm "+ currentYear);
