 ...
 * @author Admin
 */
@WebServlet(name = "ThucDonControlTin", urlPatterns = {"/ThucDonTin"})
public class ThucDonControlTin extends HttpServlet {
     ...
     protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/NhanVienJSP/ThucDonTin.jsp").forward(request, response);
    }
