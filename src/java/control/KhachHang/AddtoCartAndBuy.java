 ...
 * @author FPT
 */
@WebServlet(name = "AddtoCartAndBuy", urlPatterns = {"/addtocartandbuy"})
public class AddtoCartAndBuy extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAO dao= new DAO();
        dao.addToCart(account.getId(), ProductId, 1);
        // Update cart count
...
//            session.setAttribute("thanhtien", thanhTien);
        response.sendRedirect("cart?cartid=" + account.getId());
