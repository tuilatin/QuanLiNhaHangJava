 ...
 * @author FPT
 */
@WebServlet(name = "ThongkeChonNgay", urlPatterns = {"/tkchonngay"})
public class ThongkeChonNgay extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String ngayThangNam = request.getParameter("ngayThangNam");
           LocalDate date = LocalDate.parse(ngayThangNam); // Java 8 trở lên
        ...
        int soLuongHoaDon = dao.getSoLuongHoaDonTrongNgay(ngay,thang, nam);
        double tongDoanhThu = dao.getTongDoanhThuTrongNgay(ngay,thang, nam);
        int tongSanPhamBanRa = dao.getTongSanPhamBanTrongNgay(ngay,thang, nam);
        double tongTienGiam = dao.getTongTienGiamTrongNgay(ngay,thang, nam);
