...
public class DAO {
    ...
    public void datHang(int idND, int idBan, String codeVoucher) {
    String insertHD_SQL = """
        INSERT INTO HoaDon (ID_ND, ID_Ban, Code_Voucher)
        VALUES (?, ?, ?)
    """;
    ...
    try {
        ...
        // 4. Cập nhật lại thông tin tiền vào hóa đơn
        ...
        // 5. Copy chi tiết từ giỏ hàng sang CTHD
        ...
        conn.commit();
        System.out.println("Đặt hàng thành công. Mã hóa đơn: " + idHoaDon);
