                                            ...
                                            <c:forEach items="${listCart}" var="o">
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <form id="quantityForm${o.id}" action="updatesl" method="get">
                                                        
                                                        <input type="hidden" name="id" value="${o.id}" />
                                                        <input type="hidden" name="cartid" value="${sessionScope.acc.id}" />

                                                        <select name="quantity" onchange="submitForm(${o.id})">
                                                    ...
                                                    <td class="align-middle"><a href="deletecart?id=${o.id}" class="text-dark">
